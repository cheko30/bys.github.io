...
$(document).ready(function() {
   ...
   $tunder.show().arctext({radius: 180, dir: -1});
	...
	//Map
	var map;
	var center = new google.maps.LatLng(19.492091,-99.140167);
	...
	function initialize() {
	    ...
	    var positionpin_church  = new google.maps.LatLng(19.488779,-99.123954);
	    ...
	    boxText_church.innerHTML = '<div class="grid grid_6 percentage border-white"><div class="block-focus center"><h5>Iglesia</h5><h6>Ceremonia</h6><p>08:00 PM</p></div></div><div class="grid grid_6 percentage border-white"><img class="block-focus border-white" src="static/img/map-church.jpg"></div>';
	    ...
	    var positionpin_restaurant = new google.maps.LatLng(19.502809,-99.156041);
	    ...
	    boxText_restaurant.innerHTML = '<div class="grid grid_6 percentage border-white"><div class="block-focus center"><h5><strong>Hacienda La Patera</strong></h5><h6>Fiesta</h6><p>10:00 PM</p></div></div><div class="grid grid_6 percentage border-white"><img class="block-focus border-white" src="static/img/map-restaurant.jpg"></div>';
	...
	/*========== Countdown start ================*/
			...
			var ts = +new Date("Dec 21, 2018 08:00 GMT");
